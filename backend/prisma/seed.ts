import { PrismaClient, FuelType, Role, TaskStatus, VehicleStatus } from '@prisma/client';
...
// ── Türkiye'nin gerçek koordinatları ──────────────────────────────────────────
...
async function main() {
  ...
  // ── Gerçekçi Araç Filosu ──────────────────────────────────────────────────
  const vehicleData = [
    { plate: '34 FC 001', brand: 'Ford',    model: 'Transit',    year: 2022, fuel: FuelType.DIESEL,   km: 48200, status: VehicleStatus.ACTIVE },
    { plate: '34 FC 002', brand: 'Renault', model: 'Master',     year: 2021, fuel: FuelType.DIESEL,   km: 67300, status: VehicleStatus.ACTIVE },
    { plate: '34 FC 003', brand: 'Mercedes',model: 'Sprinter',   year: 2023, fuel: FuelType.DIESEL,   km: 21500, status: VehicleStatus.ACTIVE },
    { plate: '34 FC 004', brand: 'Volkswagen',model:'Crafter',   year: 2020, fuel: FuelType.DIESEL,   km: 89100, status: VehicleStatus.MAINTENANCE },
    { plate: '34 FC 005', brand: 'Ford',    model: 'Transit',    year: 2022, fuel: FuelType.GASOLINE, km: 35700, status: VehicleStatus.ACTIVE },
    { plate: '34 FC 006', brand: 'Renault', model: 'Kangoo',     year: 2023, fuel: FuelType.ELECTRIC, km: 14200, status: VehicleStatus.ACTIVE },
    { plate: '34 FC 007', brand: 'Fiat',    model: 'Ducato',     year: 2021, fuel: FuelType.DIESEL,   km: 55800, status: VehicleStatus.ACTIVE },
    { plate: '34 FC 008', brand: 'Peugeot', model: 'Boxer',      year: 2022, fuel: FuelType.DIESEL,   km: 41200, status: VehicleStatus.GARAGE },
    { plate: '34 FC 009', brand: 'Iveco',   model: 'Daily',      year: 2020, fuel: FuelType.DIESEL,   km: 112400,status: VehicleStatus.FAULTY },
    { plate: '34 FC 010', brand: 'Mercedes',model: 'Vito',       year: 2023, fuel: FuelType.DIESEL,   km: 18600, status: VehicleStatus.ACTIVE },
  ];
  ...
  // ── Başlangıç Konum Logları — Gerçek Türkiye Koordinatları ────────────────
  // Her aktif araç için görev rotasına uygun başlangıç noktası
  const routeStarts: Array<{ lat: number; lng: number }> = [
    { lat: 40.9886, lng: 29.0300 }, // İst Anadolu
    { lat: 41.0350, lng: 28.8790 }, // İst Avrupa
    { lat: 40.9886, lng: 29.0300 }, // İst Anadolu
    { lat: 40.7983, lng: 29.4308 }, // Gebze
    { lat: 39.9334, lng: 32.8597 }, // Ankara
    { lat: 40.9886, lng: 29.0300 }, // İst Anadolu
    { lat: 40.7650, lng: 29.9312 }, // Kocaeli
    { lat: 39.9334, lng: 32.8597 }, // Ankara
    { lat: 41.0350, lng: 28.8790 }, // İst Avrupa
    { lat: 40.1828, lng: 29.0665 }, // Bursa
  ];
